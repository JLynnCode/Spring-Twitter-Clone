...
public class UserServiceImpl implements UserService {
	...
	public UserResponseDto getUserByUsername(String username) {
		...
		Optional<User> userOptional = userRepository.findByCredentials_Username(username);
	...
	public List<TweetResponseDto> getTweetsByMention(String username) {
		...
		mentionedTweets = mentionedTweets.stream().filter(tweet -> !tweet.isDeleted()).sorted(Comparator.comparing(Tweet::getPosted)).toList();
	...
	public List<TweetResponseDto> getUserFeed(String username) {
		...
		tweets = tweets.stream().filter(tweet -> !tweet.isDeleted()).sorted(Comparator.comparing(Tweet::getPosted)).toList();
